...
const countries = [
  { code: 'IN', name: 'India', flag: '🇮🇳', languages: 'English, Hindi' },
  { code: 'KE', name: 'Kenya', flag: '🇰🇪', languages: 'English, Swahili' },
  { code: 'ET', name: 'Ethiopia', flag: '🇪🇹', languages: 'Amharic, English' },
  { code: 'NP', name: 'Nepal', flag: '🇳🇵', languages: 'Nepali, English' },
